...
while drive:
    ...
    up_pix = window.get_at((cam_x, cam_y - focal_dist ))[0]
    down_pix = window.get_at((cam_x, cam_y + focal_dist ))[0]
    right_pix = window.get_at((cam_x + focal_dist, cam_y  ))[0]
    print(up_pix,right_pix,down_pix)
